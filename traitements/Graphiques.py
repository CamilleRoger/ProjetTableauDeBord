...
nombre_article_par_an_mois = pd.read_csv(workpath+"nombre_d'article_par_mois_annee.csv", sep=',', names = ["mois-annee", "nombre_article"])
...
nombre_article_par_mois = pd.read_csv(workpath+"nombre_d'article_par_mois.csv", sep=',', names = ["mois", "nombre_article"])
...
Les_villes_les_mieux_frequentes = pd.read_csv(workpath+"Les_villes_les_mieux_frequentes.csv", sep=',', names = ["ville", "nombre_article"])
...
nombre_de_conference_dans_dans_un_pays = pd.read_csv(workpath+"nombre_de_conference_dans_un_pays.csv", sep=',', names = ["pays", "nombre_conference"])
